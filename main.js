...
commands={
	...
	"ç":function(){stack[stack.length-1]=stack[stack.length-1].split(''),stack[stack.length-1].pop(),stack[stack.length-1].join('').length?(stack[stack.length-1]=stack[stack.length-1].join('')):stack.pop()},
	"©":function(){stack=["0"]},
